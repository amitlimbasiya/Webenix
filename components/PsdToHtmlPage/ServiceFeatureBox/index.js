...
import * as s from "../../../styles/components/ResponsiveWebDesign/ServiceFeatureBox.style";
import reactUXIcon from "../../../public/images/responsiveWebDesign/reactUXIcon.svg";
import crossPlatformIcon from "../../../public/images/responsiveWebDesign/crossPlatformIcon.svg";
import appleIcon from '../../../public/images/responsiveWebDesign/appleIcon.svg';
import backendDevelopmentIcon from '../../../public/images/responsiveWebDesign/backendDevelopmentIcon.svg';
import apiDevIcon from '../../../public/images/responsiveWebDesign/apiDevIcon.svg';
import androdIcon from '../../../public/images/responsiveWebDesign/androdIcon.svg';
import codeIcon from '../../../public/images/responsiveWebDesign/codeIcon.svg';
import fullStackIcon from "../../../public/images/full-stack-icon.svg";
import frontEndDevelopmentIcon from '../../../public/images/responsiveWebDesign/frontEndDevelopmentIcon.svg';
            ...
            <s.ServiceBox className="serviceBoxes">       
                <Row>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="espressoPart">
                            <s.partItem className="imgPart">
                                <Image src={codeIcon} alt="Custom Flutter Application Development Icon" layout="raw" />
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Custom Flutter application development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="yellowPart">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Backend Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                   <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="blushPart">
                            <s.partItem className="imgPart">
                                <Image src={apiDevIcon} alt="Flutter API Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Flutter API Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                     <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="greenlightPart">
                            <s.partItem className="imgPart">
                                <Image src={androdIcon} alt="Flutter development for Android platform Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Flutter development for Android platform</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="grayPart">
                            <s.partItem className="imgPart">
                                <Image src={appleIcon} alt="Flutter development for iOS application" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Flutter development for iOS application</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="yellowPart">
                            <s.partItem className="imgPart">
                                <Image src={crossPlatformIcon} alt="Flutter cross-platform development services Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Flutter cross-platform development services</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="blushPart">
                            <s.partItem className="imgPart">
                                <Image src={reactUXIcon} alt="UI/UX Design Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>UI/UX Design</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>    
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="carolinaBluePart">
                            <s.partItem className="imgPart">
                                <Image src={frontEndDevelopmentIcon} alt="Front-end Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>Front-end Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>                    
                </Row>
             </s.ServiceBox>
