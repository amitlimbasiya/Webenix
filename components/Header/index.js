            ...
            <Nav className="menu" id="menu">
              <s.MenuSection className="menu-section">
                <s.MenuItemHasChildren className="menu-item menu-item-has-children">
                  <Link href="#">
                    <a className="menulist-title">About</a>
                  </Link>
                  <span className="mobileClick submenu-icon">
                ...
                <s.MenuItemHasChildren className="menu-item menu-item-has-children">
                  <Link href="#">
                    <a className="menulist-title">Services</a>
                  </Link>
                  <span className="mobileClick submenu-icon">
                    <FontAwesomeIcon icon={faAngleDown} />
                  </span>
                  <s.MenuSub className="menu-subs menu-mega menu-column-3">
                    <s.MenuColumn className="menucolumn">
                      <s.MenuListItem className="menulist-item">
                        <s.MenuListTitle className="menulist-title">
                          Design{" "}
                        </s.MenuListTitle>
                        <s.MenuItemBlock className="menuitem-block">
                        ...
                        <s.MenuItemBlock className="menuitem-block twoPart">
                          <Link href={router.PGI}>
                            <a className="menuitem-box">
                              <s.MenuItemText className="menuitem-text">
                                <Image
                                  src={paymentGatwayIntegrationIcon}
                                  alt="Payment Gateway Integration Icon"
                                  layout="raw"
                                />
                          ...
                          <Link href={router.SHIPPINGINTEGRATION}>
                            <a className="menuitem-box">
                              <s.MenuItemText className="menuitem-text">
                                <Image
                                  src={shippingIntegrationIcon}
                                  alt="Shipping Integration Icon"
                                  layout="raw"
                                />
                          ...
                          <Link href={router.TPAI}>
                            <a className="menuitem-box">
                              <s.MenuItemText className="menuitem-text">
                                <Image
                                  src={thirdPartyAPIntegrationIcon}
                                  alt="third-party-API-Integration-icon"
                                  layout="raw"
                                />
                          ...
                          <Link href={router.SUPPORTANDMAINTENANCE}>
                            <a className="menuitem-box">
                              <s.MenuItemText className="menuitem-text">
                                <Image
                                  src={supportMaintain}
                                  alt="Support and Maintanance icon"
                                  layout="raw"
                                />
                ...
                <s.MenuItemHasChildren className="menu-item menu-item-has-children">
                  <Link href="#" className="menulist-title">
                    Technologies
                  </Link>
                  <span className="mobileClick submenu-icon">
                    <FontAwesomeIcon icon={faAngleDown} />
                ...
                <s.MenuItemHasChildren className="menu-item menu-item-has-children">
                  <Link href="#">
                    <a className="menulist-title">Hire Developers</a>
                  </Link>
                  <span className="mobileClick submenu-icon">
                    <FontAwesomeIcon icon={faAngleDown} />
                  </span>
                        ...
                        <s.MenuItemBlock className="menuitem-block">
                          ...
                          <Link href={router.HIRECONTENTWRITER}>
                            <a className="menuitem-box">
                              <s.MenuItemText className="menuitem-text">
                                <Image
                                  src={contentWriterIcon}
                                  alt="Hire Content Writer"
                                  layout="raw"
                                />
                ...
                <s.MenuItemHasChildren className="menu-item">
                  <Link href={router.BLOG} className="menulist-title">
                    Blog
                  </Link>
                </s.MenuItemHasChildren>

                <s.MenuItemHasChildren className="menu-item">
                  <Link href={router.WORK} className="menulist-title">
                    Work
                  </Link>
                </s.MenuItemHasChildren>
              </s.MenuSection>
