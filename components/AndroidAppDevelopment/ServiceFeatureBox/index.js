...
import migrationIcon from '../../../public/images/androidAppDevelopment/migrationIcon.svg';
import pluginIcon from '../../../public/images/androidAppDevelopment/pluginIcon.svg';
import codeIcon from '../../../public/images/androidAppDevelopment/codeIcon.svg';
import fullStackIcon from "../../../public/images/full-stack-icon.svg";
import frontEndDevelopmentIcon from '../../../public/images/androidAppDevelopment/frontEndDevelopmentIcon.svg';
    ...
    <s.ServiceFeatureBox>
        <Container>
            <s.SectionTagline>
                ...
                <h2>Our Android App Development Services</h2>
            </s.SectionTagline>
                    ...
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="grayPart">
                            <s.partItem className="imgPart">
                                <Image src={pluginIcon} alt="Enterprise Android App Development Icon" layout="raw" />
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Enterprise Android App Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="carolinaBluePart">
                            <s.partItem className="imgPart">
                                <Image src={fullCycleAppIcon} alt="Android Full-cycle App development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Android Full-cycle App development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                   <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="carolinaBluePart">
                            <s.partItem className="imgPart">
                                <Image src={migrationIcon} alt="Android App Migration Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Android App Migration</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                     <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="espressoPart">
                            <s.partItem className="imgPart">
                                <Image src={codeIcon} alt="App Testing Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>App Testing</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    ...
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="yellowPart">
                            <s.partItem className="imgPart">
                                <Image src={maintenanceSupportIcon} alt="Maintenance & Support Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Maintenance & Support</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="blushPart">
                            <s.partItem className="imgPart">
                                <Image src={reactUXIcon} alt="Android M-commerce Applications Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>UI/UX App Design</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="purplePart">
                            <s.partItem className="imgPart">
                                <Image src={fullStackIcon} alt="Android App API Integrations Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>Android App API Integrations</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>    
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="carolinaBluePart">
                            <s.partItem className="imgPart">
                                <Image src={frontEndDevelopmentIcon} alt="UI/UX App Design Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>Android M-commerce Applications</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>                    
                </Row>
             </s.ServiceBox>
