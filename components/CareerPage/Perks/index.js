...
function MyVerticallyCenteredModal(props) {
  ...
  function sendEmail(e) {
    ...
    Email.send({
      ...
      Body:
        '<table width="640" align="left" border="1"><tr><td>Name</td><td>' +
        contact_fname +
        '</td></tr><tr><td>Email</td><td>' +
        contact_email +
        '</td></tr><tr><td>Job Position</td><td>' +
        contact_company +
        '</td></tr><tr><td>Number of experience</td><td>' +
        number_of_experience +
        '</td></tr><tr><td>Contact</td><td>' +
        contact_phone +
        '</td></tr><tr><td>Cover letter</td><td style="width:50%">' +
        message +
        '</td></tr></table>',
      Attachments: [
        {
    ...
    >
      ...
      <Modal.Body>
        <form onSubmit={sendEmail} enctype="multipart/form-data">
          ...
          <span className="new-errormessage" Style={recaptchaError}>
            ...
            <Accordion defaultActiveKey="0">
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <div className="cardHeader">
                    <div className="headIcon">
                      <Image
                        src={wordpressDevIcon}
                        alt="Wordpress Developer Icon"
                        className="img-fluid"
                        layout="raw"
                      />
                    </div>
                    <div className="positionDesc">
                      ...
                      <ul className="btmBar">
                        <li>
                          <span>Experience:</span> Minimum 1 year
                        </li>
                        <li>
                          <span>No. of Openings:</span> 1
                        </li>
                        <li>
                          <span>Qualifications:</span> B.E / B.Tech
                        </li>
                      </ul>
                    </div>
                    <div className="buttonPart">
                      <Link href="#">
                        ...
                        <a
                          onClick={() => formOpen('Wordpress Developer')}
                          className="btn-default btn-arrow"
                        >
                          Apply Now
                        </a>
                      </Link>
                ...
                <Accordion.Body>
                  <ul>
                    <li>
                      Minimum 1 year of experience developing websites using
                      WordPress.
                    </li>
                    <li>WordPress plugin development / theme development.</li>
                    <li>
                      Setup of WordPress options, plugin installation and
                      configuration.
                    </li>
                    <li>
                      Good knowledge for database admin (MySQL) via PHPMyAdmin.
                    </li>
                    <li>
                      Strong knowledge and proficiency in core PHP programming,
                      MySQL with OOPS concepts.
                    </li>
                    <li>Experience working on AJAX, JavaScript & jQuery.</li>
                    <li>
                      Scope, analyze, design, test, debug and implement complex
                      applications.
                    </li>
                    <li>
                    ...
                    <li>
                      Research and remain informed of new technology and
                      development tools.
                    </li>
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header>
                  <div className="cardHeader">
                    <div className="headIcon">
                      <Image
                        src={careerIcon}
                        alt="Business Development Executive Icon"
                        className="img-fluid"
                        layout="raw"
                      />
                    </div>
                    <div className="positionDesc">
                      ...
                      <ul className="btmBar">
                        ...
                        <li>
                          <span>No. of Openings:</span> 2-3
                        </li>
                        <li>
                          <span>Qualifications:</span> MBA, MCA, BE in
                          IT/Computer
                        </li>
                      </ul>
                    </div>
                    <div className="buttonPart">
                      <Link href="#">
                        <a
                          onClick={() =>
                            formOpen('Business Development Executive')
                          }
                          className="btn-default btn-arrow"
                        >
                          Apply Now
                ...
                <Accordion.Body>
                  <p className="mb-3">
                    We are looking for an experienced individual for the post of
                    Business Development Executive with experience in
                    international sales in the IT company! As a Business
                    Development Executive, you will be responsible for finding
                    new clients and increasing sales.
                  </p>
                  <ul>
                    <li>
                      Effective communication(verbal and written) with English
                      fluency.
                    </li>
                    <li>
                      Experience in the IT service sector for International
                      sales.{' '}
                    </li>
                    <li>
                      Generate leads through Different channels like the
                      internet, social media, bidding portals etc.
                    </li>
                    <li>Experience working with different bidding portals.</li>
                    <li>
                      Understand client requirements and could provide work
                      estimation, Proposal, Cost Estimates, and Timeline
                      Estimation accordingly.
                    </li>
                    <li>
                      Experience in creating project Scope/Proposal/RFP
                      documents.
                    </li>
                    <li>
                      Can Individually coordinate with clients and help them
                      solve problems.
                    </li>
                    <li>
                      Convert prospects into consumers and close the deals.
                    </li>
                    <li>
                      Build a good network with existing clients to generate
                      repeat business.
                    </li>
                    <li>Provide Monthly work report to the Management.</li>
                    <li>
                      Remaining in tune with trends to ensure that our offerings
                      remain relevant.
                    </li>
                  </ul>
                </Accordion.Body>
          ...
          <Container>
            <Row className="mb-5 pb-3">
              <Col md={12}>
                ...
                <s.SectionHeader>
                  <p>
                    <strong>Webenix Technologies</strong> is the right business
                    organization if you want to grow and acknowledge your
                    efforts. No matter whether you are an experienced geek or an
                    intern peer, we will be right here for you to shape your
              ...
              <Col md={7} lg={6}>
                <div className="perk-plate">
                  ...
                  <div className="perk-desc">
                    Learning and seeking is the main motto for our organization,
                    where we ensure to provide the best resources and support at
                    3x speed with an open environment of always seeking
                    knowledge.
                  </div>
                </div>
                ...
                <div className="perk-plate">
                  <div className="perk-title">
                    ...
                    <div className="perk-tit">
                      Work for the enterprise organizations
                    </div>
                  </div>
                  <div className="perk-desc">
                    We help you to build the best portfolio by taking up
                    high-value projects along with gaining knowledge.
                  </div>
                </div>
              </Col>
          ...
          <Container>
            <Row className="align-items-center right-perk">
              <Col
                md={5}
                lg={6}
                className="text-center order-last order-md-first"
              >
              ...
              <Col md={7} lg={6} className="order-first order-md-last">
                <div className="perk-plate">
                  ...
                  <div className="perk-desc">
                    We believe in the flexibility mode of working to emboss the
                    best efforts out from the team where you get to work with
                    zero pressure allowance.
                  </div>
                </div>
                ...
                <div className="perk-plate">
                  <div className="perk-title">
                    ...
                    <div className="perk-tit">
                      Seek, gain and outgrow your knowledge with us{' '}
                    </div>
                  </div>
                  <div className="perk-desc">
                    We want our teammates to outgrow their journey with us by
                    relishing the business trips globally and knowing the power
                    of diversity and work culture.
                  </div>
                </div>
              </Col>
            </Row>
          ...
          <Row>
            <Col md={12}>
              <s.Tagline>
                ...
                <h2>
                  Cherish and embrace your career days by looking for better
                  Jobs Opportunity in Webenix
                </h2>
              </s.Tagline>
            </Col>
          </Row>
