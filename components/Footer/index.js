...
import skypeLogo from '../../public/images/moTeams.svg';
  ...
  return (
    <>
      <s.footer>
        ...
        <Container>
          <s.topRow className="topRow">
            <s.heading className="ftHeading">
              WEBENIX Technologies Pvt. Ltd.
            </s.heading>
            <s.heading className="ftAddress">
              1308, The Spire 2, <br />
              Shital Park BRTS, 150ft Ring Road,
              <br />
            ...
            <s.contactInfo className="contactInfo">
              <s.infoBox className="infoBox">
                ...
                <s.infoDesc className="infoDesc">
                  <s.spanPart>Microsoft Teams</s.spanPart>
      ...
      <s.copyRight>
        <Container>
          <s.copyText>
            &copy; Webenix Technologies Pvt. Ltd. - All rights reserved
          </s.copyText>
        </Container>
      </s.copyRight>
    </>
