            ...
            <Col lg={6} md={12} className="itemBoxes">
              <s.boxPart className="purplePart">
                <s.partItem className="textPart">
                    ...
                    <s.textPart>Content Marketing is the real sense of posting the blogs, articles, and other content at the right time and in the most accurate ways with the right amount of keywords stuffed for boosting the reach to the next level.</s.textPart>
                    <Link href='/'>
                        <a className='linkPart'>Learn More &#8594;</a>
                    </Link>
                </s.partItem>
