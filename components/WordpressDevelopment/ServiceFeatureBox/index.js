...
import SocialMedia from '../../../public/images/smo-icon.svg';
import Infographics from '../../../public/images/prototypeIcon.svg';
import LandingPage from '../../../public/images/web-development-icon.svg';
import Stationery from '../../../public/images/about-icon.svg';
                ...
                <Row>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="greenlightPart">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Logo</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                   <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="redPart">
                            <s.partItem className="imgPart">
                                <Image src={Stationery} alt="Frontend Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Stationery</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                     <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="yellowPart">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Web Design</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="saffronPart">
                            <s.partItem className="imgPart">
                                <Image src={LandingPage} alt="Landing Page Design Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Landing Page</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="purplePart">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Mobile App</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="lightPinkPart">
                            <s.partItem className="imgPart">
