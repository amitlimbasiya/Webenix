...
import apiDevIcon from '../../../public/images/nodejsDevelopment/apiDevIcon.svg';
import backendDevelopmentIcon from '../../../public/images/nodejsDevelopment/backendDevelopmentIcon.svg';
import frontEndDevelopmentIcon from '../../../public/images/nodejsDevelopment/frontEndDevelopmentIcon.svg';
                    ...
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="yellowPart">
                            <s.partItem className="imgPart">
                                <Image src={apiDevIcon} alt="API Development and Integration Icon" layout="raw" />
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Node.js API Development and Integration</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                   <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="greenlightPart">
                            <s.partItem className="imgPart">
                                <Image src={frontEndDevelopmentIcon} alt="API and Package Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Nodejs API and Package Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                     <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="saffronPart">
                            <s.partItem className="imgPart">
                                <Image src={serverSideIcon} alt="Server Side Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Node.js Server Side Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="grayPart">
                            <s.partItem className="imgPart">
                                <Image src={pluginIcon} alt="" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Node.js Plugin Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="carolinaBluePart">
                            <s.partItem className="imgPart">
                                <Image src={backendDevelopmentIcon} alt="React App Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Back-end Dashboards Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="purplePart">
                            <s.partItem className="imgPart">
                                <Image src={fullStackIcon} alt="Migration Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                            ...
                            <s.partItem className="textPart"><s.boxHeading>Node.js Integration Solution</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="greenlightPart">
                            <s.partItem className="imgPart">
                                <Image src={cmsDevelopmentIcon} alt="Bug Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>Node.js CMS Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>    
                    <Col lg={3} sm={6} className="itemBoxes">
                        <s.boxPart className="blushPart">
                            <s.partItem className="imgPart">
                                <Image src={reactUXIcon} alt="Maintenance Support Development Icon" layout="raw" />
                                <s.iconOverlay className="overlayImg">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>
                                </s.iconOverlay>
                            </s.partItem>
                            <s.partItem className="textPart"><s.boxHeading>Node.js for UI/UX Development</s.boxHeading></s.partItem>
                        </s.boxPart>
                    </Col>                    
                </Row>
             </s.ServiceBox>
