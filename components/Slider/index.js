...
import skypeIcon from '../../public/images/teamBlack.svg';
      ...
      <s.SliderCompany className="homeSlider">
          ...
          <Row className="align-items-center justify-content-between sliderBanner">
            <Col md={12} lg={6} xl={6}>
              <s.bannerLeft className="bannerLeft">
                <s.bannerHeading>
                  <strong className="highlightText">Empower</strong> your{' '}
                  <strong className="highlightText">business</strong> with
                  <br />
                  <strong className="highlightText">
                    {' '}
                    skilful team
                  </strong> and{' '}
                  <strong className="highlightText">top-notch </strong>
                  <br />
                  <span className="textGreen"> service experiences.</span>
                </s.bannerHeading>
                <s.bannerIcons className="bannerIcons">
                  <s.iconBox className="bannerIcon">
                    <Image src={onTimeIcon} alt="On Time Icon" layout="raw" />
                    <s.iconHeading>On Time</s.iconHeading>
                  </s.iconBox>
                  <s.iconBox className="bannerIcon">
                    <Image
                      src={qualityServiceIcon}
                      alt="Quality Service Icon"
                      layout="raw"
                    />
                    <s.iconHeading>Quality Service</s.iconHeading>
                  </s.iconBox>
                  <s.iconBox className="bannerIcon">
                    <Image
                      src={costIcon}
                      ...
                      layout="raw"
                    />
                    <s.iconHeading>Cost Effective</s.iconHeading>
                  </s.iconBox>
                </s.bannerIcons>
              </s.bannerLeft>
            </Col>
        ...
        <s.screenBottomBar className="btmBar">
          <s.leftPart className="leftPart">
            ...
            <Link href="https://teams.microsoft.com/l/chat/0/0?users=anand.patadiya@hotmail.com">
              <a>
                <Image
                  src={skypeIcon}
