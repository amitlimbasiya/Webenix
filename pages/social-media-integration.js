...
const SMI = () => {
  return (
    <>
      <Head>
        <title>{data.smi.title}</title>
        <meta name="description" content={data.smi.description}/>
        <meta name="keywords" content={data.smi.keyword} />
      </Head>
    <PageBanner 
    ...
    <SectionIntro 
      ...
      IntroContent='
      <p>When it comes to <strong>Social Networking API Integration</strong>, which has become the most crucial part of any business to run, we help in integrating it on your website and mobile application. The whole business process becomes effortless by easy social sharing of content.</p>
      <p>We at Webenix, help to bring the industry-specific <strong>Social Networking API Integration</strong> to help businesses over websites and mobile apps to integrate into the finest ways possible. Social media includes Facebook, Twitter, LinkedIn, Instagram, Youtube and several specific others.</p>
    '/>
    <OurExpertise/>
    <SectionIntro 
      SectionIntroclassName="introuction-section noiseBg"
      ...
      <p>Do you want to help in utilizing social media power in the best ways? Webenix has social media API integration experts that help in social engagement with your customers.</p>
    '/>
    <HireServies/>
    <TechnologyStack/>
    <SteptoEngage/>
