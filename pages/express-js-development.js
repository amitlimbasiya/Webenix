...
const EXPRESSJSDEVELOPMENT = () => {
    ...
    const services = [
      {
        ...
        ServiceIcon:"/images/f-express-js-banner-icon.svg",
      ...
      },
      {
        ...
        ServiceIcon:"/images/f-CMS-Development.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
  ...
  return (
    <>
       <Head>
        <title>{data.expressjsdevelopment.title}</title>
        <meta name="description" content={data.expressjsdevelopment.description}/>
        <meta name="keywords" content={data.expressjsdevelopment.keyword} />
      </Head>
      <PageBanner 
        ...
        PageBannerImage="/images/f-express-js-banner-icon.svg"
      />
    <SectionIntro 
