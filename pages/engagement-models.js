  ...
  return (
    <>
      ...
      <SectionIntro 
        ...
        IntroContent='
          <p>Webenix offers an array of flexible engagement models to best suit your needs. Whether you are looking to hire a dedicated developer on an hourly basis, go with a hybrid model, setup an offshore team, or use a fixed price model, Webenix has options to meet your specific requirements.</p>
      '/>
      <s.SectionTagline>
        <Container>
