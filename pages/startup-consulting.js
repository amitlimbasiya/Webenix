...
const STARTUPCONSULTING = () => {
  return (
    ...
    <PageBanner 
        ...
        PageBannerContent="<p><strong>Are you a new startup founder?</strong> Startups need attention right from the initial days considering the right technology selection to developing the digital presence with <strong>Startup Consultant</strong>. Right from the beginning, we thrive to take out the best from your business that will gradually be the brand of your customers globally. From raising the visibility of your business to raising the value, we make sure that everything is done in the presence of highly experienced experts.</p>" 
    ...
    <SectionIntro 
      ...
      IntroContent='
      <p><strong>Startup Consulting Firms</strong> should be chosen wisely especially when you are considering making it big and sustainable. Initial steps are crucial and hence <strong>Startup Consulting Services</strong> need to get nurtured by professionals and experts.</p>
