  ...
  return (
    <>
      ...
      <PageBanner 
        ...
        PageBannerContent="<p>We at Webenix, have a team of skilful PHP developers with proficiency in PHP web platforms for many years. If you are finding the development for the PHP platforms, then Webenix is the one-stop solution to <strong>Hire Dedicated PHP Developers</strong></p>"
    ...
    <SectionIntro 
      ...
      IntroMainTitle="Hire PHP Developers if you are looking for a strong backend force."
      IntroContent='
      <p>Develop a strong backend for the smooth functionality of apps and software, do not let your business wait any longer. </p>
      <p>Webenix has been into PHP development for more than a decade now, with the core PHP frameworks like Laravel we have been into developing the strong backend for better functionality and here for <strong>PHP Developer For Hire</strong>.</p>
    '/>
      <HiringModels/>
      <OurExpertise/>
      <Benefits/>
