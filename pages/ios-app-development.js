  ...
  return (
    <>
      ...
      <PageBanner 
        ...
        PageBannerContent="<p>Webenix stands high considering the <strong>iOS App Development Company</strong> that challenges to create pixel-perfect designs which are user-friendly and hold up strong backend solutions. <strong>iOS App Development Services</strong> cater to a strong product which is bold and innovative to use.</p>"
