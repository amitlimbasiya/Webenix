  ...
  return (
    <>
      ...
      <SectionIntro 
        ...
        <p>Webenix has been into front-end development for decades and has created 150+ projects for the mid and Eenterprise-level. Considering the complete look to the functionality, everything is taken care of by our team. </p>
      '/>
      <ServiceFeatureBox/>
      <HireServies/>
      <TechnologyStack/>
