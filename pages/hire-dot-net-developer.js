  ...
  return (
    <>
      ...
      <PageBanner 
        ...
        PageBannerContent="<p>Hire .Net Developer as it is considered to be the most preferred technology that is introduced by Microsoft technology to acquire the business industries like financial companies of banking, insurance, fintech, logistic, security and much more. </p>"
    ...
    <SectionIntro 
      ...
      IntroContent='
      <p><strong>Hire .NET developers</strong>, observe the magical move in your business Empower your financial business with the Microsoft technology stack</p>
      ...
      <p><strong>Hire .NET developers</strong> from Webenix and get competitive prices with the timely completion of projects. </p>
    '/>
      <HiringModels/>
      <OurExpertise/>
      <Benefits/>
