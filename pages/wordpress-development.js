...
const WORDPRESSDEVELOPMENT = () => {
    ...
    const services = [
      {
        ...
        ServiceIcon:"/images/f-wordpress-icon.svg",
        ...
        ServiceName:"WordPress <br>Development"
      },
      {
        key:2,
        ServiceBoxClass:"redPart",
        ServiceIcon:"/images/f-WordPress-Theme-Integration.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ...
        ServiceName:"WordPress Theme <br> Integration"
      },
      {
        key:3,
        ServiceBoxClass:"yellowPart",
        ServiceIcon:"/images/f-WordPress-Theme-Customization.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ...
        ServiceName:"WordPress Theme <br> Customization"
      },        
      {
        key:4,
        ServiceBoxClass:"saffronPart",
        ServiceIcon:"/images/f-WordPress-Plugin-Development.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ...
        ServiceName:"WordPress Plugin <br> Development"
      },
      {
        key:5,
        ServiceBoxClass:"purplePart",
        ServiceIcon:"/images/f-WordPress-Plugin-Customization.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ...
        ServiceName:"WordPress Plugin <br> Customization"
      },
      {
        key:6,
        ServiceBoxClass:"lightPinkPart",
        ServiceIcon:"/images/f-WordPress-Theme-Development.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ...
        ServiceName:"WordPress Theme <br> Development"
      },
      {
        key:7,
        ServiceBoxClass:"pinkPart",
        ServiceIcon:"/images/f-WooCommerce-Development.svg",
        ServiceIconHeight:"90px",
        ServiceIconWidth:"90px",
        ServiceSvgShape:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210.35 155.44"><g className="cls-1"><g id="Layer_1" data-name="Layer 1"><path className="cls-2" d="M726.05,313.86c-33.8-13.77-36.35-47.47-57.44-59.89-20.67-12.18-42.86-.48-51.53,33.16-9.84,38.23-35.12,46.6-48.57,74.78-5.66,11.85-3.11,34.47,12,40.67,19.82,8.15,39.12-9.22,63.72-15,22.09-5.21,52.94-.34,73.77-1.55,20.42-1.19,42.19,1.71,54.76-17.95C781.07,355,776.72,334.5,726.05,313.86Z" transform="translate(-565.74 -249.28)"/></g></g></svg>',
        ServiceName:"WooCommerce <br> Development"
      },
      {
        key:8,
        ...
        ServiceName:"WordPress Maintenance <br> and Support"
      }
      ];
  ...
  return (
    <>
      <Head>
        <title>{data.wordpressdevelopment.title}</title>
        <meta name="description" content={data.wordpressdevelopment.description}/>
        <meta name="keywords" content={data.wordpressdevelopment.keyword} />
      </Head>
    <PageBanner 
        ...
        PageBannerImage="/images/f-wordpress-icon.svg"
    />
    <SectionIntro 
